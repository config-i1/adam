...
\begin{verbatim}
##         h1         h2         h3 
## 0.09514205 0.11033067 0.10595530
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.09168208 0.10005008 0.09741543
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 521.7712
## Error standard deviation: 30.7645
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1049.542 1049.773 1057.589 1058.129 
## 
## 95% parametric prediction interval was constructed
## 83% of values are in the prediction interval
## Forecast errors:
## MPE: 2.2%; sCE: 28.2%; Asymmetry: 77.5%; MAPE: 2.9%
## MASE: 0.951; sMAE: 2.9%; sMSE: 0.2%; rMAE: 0.425; rRMSE: 0.513
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 664.6409
## Error standard deviation: 0.1061
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1335.282 1335.513 1343.328 1343.868 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: -3.2%; sCE: -27.4%; Asymmetry: -30.7%; MAPE: 8%
## MASE: 0.777; sMAE: 7.5%; sMSE: 0.8%; rMAE: 1; rRMSE: 1.03
\end{verbatim}
...
##  -6.12354974  15.50114184 484.12462136  -0.01737715   0.03386059  -0.27994178 
##         sMAE         sMSE         MASE        RMSSE         rMAE        rRMSE 
##   0.05905367   0.00702625   0.64362903   0.70224504   0.20396239   0.21366841 
##         rAME    asymmetry         sPIS 
##   0.08604520  -0.26624904   2.26748918
\end{verbatim}
...
The plot in Figure \ref{fig:adamModelSeat05ResidFitted} demonstrates that there are outliers, some of which are further away from the bounds. Although the amount of outliers is not large, it would make sense to investigate why they happened.
...
## 141 257.6550           254.8873            260.4094
## 142 257.7010           253.3134            262.0757
## 143 257.7481           251.8409            263.6520
## 144 257.8016           250.3127            265.2026
## 145 257.8499           248.7673            266.7976
## 146 257.9057           247.2764            268.4943
## 147 257.9437           245.7009            270.2281
## 148 257.9970           244.1167            271.8710
## 149 258.0339           242.5927            273.6069
## 150 258.0614           241.0231            275.3328
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.022  0.000  0.003  0.016 -0.026
## beta   0.000  0.008 -0.001 -0.008  0.023
## phi    0.003 -0.001  0.013  0.056 -0.061
## level  0.016 -0.008  0.056  0.487 -0.656
## trend -0.026  0.023 -0.061 -0.656  0.971
\end{verbatim}
...
\hypertarget{connection-with-arch-and-garch-adamscalemodelgarch}{%
\section{Connection with ARCH and GARCH \{ADAMscaleModelGARCH\}}\label{connection-with-arch-and-garch-adamscalemodelgarch}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{adamLocationModel }\OtherTok{\textless{}{-}} \FunctionTok{adam}\NormalTok{(SeatbeltsData, }\StringTok{"MNM"}\NormalTok{, }\AttributeTok{h=}\DecValTok{12}\NormalTok{, }\AttributeTok{holdout=}\ConstantTok{TRUE}\NormalTok{,}
                          \AttributeTok{formula=}\NormalTok{drivers}\SpecialCharTok{\textasciitilde{}}\FunctionTok{log}\NormalTok{(kms)}\SpecialCharTok{+}\FunctionTok{log}\NormalTok{(PetrolPrice)}\SpecialCharTok{+}\NormalTok{law,}
                          \AttributeTok{distribution=}\StringTok{"dnorm"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfcol=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(adamLocationModel,}\FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{8}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{spread}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\AttributeTok{resid=}\FunctionTok{as.vector}\NormalTok{(}\FunctionTok{resid}\NormalTok{(adamLocationModel)),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{adamScaleModel }\OtherTok{\textless{}{-}} \FunctionTok{sm}\NormalTok{(adamLocationModel, }\AttributeTok{model=}\StringTok{"NNN"}\NormalTok{, }\AttributeTok{formula=}\NormalTok{drivers}\SpecialCharTok{\textasciitilde{}}\NormalTok{law)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(adamScaleModel,}\DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Figure \ref{fig:adamModelETSXMNMSMTime} demonstrates how the scale of the model changes over time. We can see that, when the law was introduced, the variance of the error term has increased slightly. In order to see if the change was substantial, we can analyse the summary of the model:

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(adamScaleModel)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{adamModelMerged }\OtherTok{\textless{}{-}} \FunctionTok{implant}\NormalTok{(adamLocationModel, adamScaleModel)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{setNames}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FunctionTok{AICc}\NormalTok{(adamLocationModel),}\FunctionTok{AICc}\NormalTok{(adamModelMerged)),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{adamLocationModel }\OtherTok{\textless{}{-}} \FunctionTok{adam}\NormalTok{(AirPassengers, }\AttributeTok{h=}\DecValTok{10}\NormalTok{, }\AttributeTok{holdout=}\ConstantTok{TRUE}\NormalTok{,}
                          \AttributeTok{distribution=}\StringTok{"dinvgauss"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(adamLocationModel,}\DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{adamScaleModel }\OtherTok{\textless{}{-}} \FunctionTok{sm}\NormalTok{(adamLocationModel, }\AttributeTok{model=}\StringTok{"YYY"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(}\FunctionTok{forecast}\NormalTok{(adamModelMerged}\SpecialCharTok{$}\NormalTok{scale,}
