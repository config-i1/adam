...
Figure \ref{fig:adamExampleNormal} shows an example with a well-behaved demand, for which the best point forecast is the straight line. To capture the uncertainty of demand, we can construct the prediction interval, which will tell which bound the demand will lie in \(1-\alpha\) per cent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (significance level \(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 82.03 and 117.84. Capturing the uncertainty correctly is important because real-life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.10417731 0.08350526 0.08826875
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.10329799 0.08348979 0.08974813
\end{verbatim}
...
\NormalTok{testModel }\SpecialCharTok{|}\ErrorTok{\textgreater{}}
  \FunctionTok{forecast}\NormalTok{(}\FunctionTok{tail}\NormalTok{(xreg, }\DecValTok{20}\NormalTok{), }\AttributeTok{h=}\DecValTok{20}\NormalTok{) }\SpecialCharTok{|}\ErrorTok{\textgreater{}}
...
## 
## Loss function type: likelihood; Loss function value: 546.0922
## Error standard deviation: 38.5346
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1098.184 1098.415 1106.231 1106.771 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: 3.8%; sCE: 47.4%; Asymmetry: 89.1%; MAPE: 4%
## MASE: 0.916; sMAE: 4.2%; sMSE: 0.3%; rMAE: 0.56; rRMSE: 0.656
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 610.0334
## Error standard deviation: 0.0807
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1226.067 1226.298 1234.113 1234.653 
## 
## 95% parametric prediction interval was constructed
## 83% of values are in the prediction interval
## Forecast errors:
## MPE: 11.4%; sCE: 148.3%; Asymmetry: 100%; MAPE: 11.4%
## MASE: 1.403; sMAE: 12.4%; sMSE: 1.8%; rMAE: 2.612; rRMSE: 2.154
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.604385235  15.500269154 479.946588828  -0.016309146   0.033756826 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.256207862   0.059050349   0.006965613   0.643592792   0.699208264 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.203950910   0.212744422   0.078750144  -0.223550556   2.104172575
\end{verbatim}
...
## 141 257.6545           254.8424            260.4702
## 142 257.6915           253.2525            262.1257
## 143 257.7397           251.7597            263.7453
## 144 257.7892           250.2776            265.3246
## 145 257.8408           248.8452            266.9298
## 146 257.8821           247.2589            268.6239
## 147 257.9264           245.7905            270.2160
## 148 257.9681           244.1012            272.0085
## 149 258.0042           242.5061            273.5550
## 150 258.0478           240.8419            275.3654
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.013  0.004  0.003  0.012 -0.013
## beta   0.004  0.005  0.000 -0.003  0.012
## phi    0.003  0.000  0.010  0.044 -0.048
## level  0.012 -0.003  0.044  0.468 -0.668
## trend -0.013  0.012 -0.048 -0.668  1.029
\end{verbatim}
