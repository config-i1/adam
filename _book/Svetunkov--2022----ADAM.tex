...
Figure \ref{fig:adamExampleNormal} shows an example with a well-behaved demand, for which the best point forecast is the straight line. To capture the uncertainty of demand, we can construct the prediction interval, which will tell which bound the demand will lie in \(1-\alpha\) per cent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 79.19 and 122.34. Capturing the uncertainty correctly is important because real-life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.06424619 0.07691491 0.06750232
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05950601 0.07247047 0.06566470
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 521.8541
## Error standard deviation: 30.7881
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1049.708 1049.939 1057.755 1058.295 
## 
## 95% parametric prediction interval was constructed
## 58% of values are in the prediction interval
## Forecast errors:
## MPE: -6.3%; sCE: -66.3%; Asymmetry: -100%; MAPE: 6.3%
## MASE: 1.995; sMAE: 5.5%; sMSE: 0.4%; rMAE: 1.149; rRMSE: 1.112
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 640.6415
## Error standard deviation: 0.1035
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1287.283 1287.514 1295.329 1295.870 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 0.1%; sCE: 9.2%; Asymmetry: -1.5%; MAPE: 5.8%
## MASE: 0.659; sMAE: 6.6%; sMSE: 0.8%; rMAE: 0.879; rRMSE: 0.977
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -6.032347598  15.604023087 487.019288513  -0.017212612   0.034066796 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.275772420   0.059445613   0.007068262   0.647900800   0.704341339 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.205316093   0.214306236   0.084763666  -0.254495394   2.218747413
\end{verbatim}
...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
If we assume that \(\epsilon_t \sim \mathcal{N}(0,\sigma^2_t)\), then the general scale model with ETS+ARIMA+Reg elements can be formulated as (Section \ref{ADAMETSPureMultiplicative}, Subsection \eqref{eq:ADAMARIMAMultiplicative} and Section \ref{ADAMXDynamic}):
\begin{equation}
  \begin{aligned}
...
## 141 257.6617           254.8968            260.4213
## 142 257.7233           253.3535            262.0675
## 143 257.7662           251.8169            263.7241
## 144 257.8104           250.3401            265.3624
## 145 257.8577           248.8328            266.9365
## 146 257.9064           247.3033            268.5971
## 147 257.9432           245.7303            270.2150
## 148 257.9739           244.0946            271.9522
## 149 258.0211           242.4330            273.7335
## 150 258.0739           240.6935            275.5202
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.017  0.002  0.003  0.013 -0.015
## beta   0.002  0.006 -0.001 -0.012  0.019
## phi    0.003 -0.001  0.013  0.057 -0.057
## level  0.013 -0.012  0.057  0.564 -0.758
## trend -0.015  0.019 -0.057 -0.758  1.116
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 24 units, while the upper bound of the interval was approximately 28. Based on that upper bound, we could place an order (based on what we already have in stock) and have an appropriate safety stock.
