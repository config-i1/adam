...
Figure \ref{fig:adamExampleNormal} shows an example with a well-behaved demand, for which the best point forecast is the straight line. To capture the uncertainty of demand, we can construct the prediction interval, which will tell which bound the demand will lie in \(1-\alpha\) per cent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (significance level \(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 79.05 and 121.14. Capturing the uncertainty correctly is important because real-life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05346869 0.05458871 0.04930765
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05882681 0.05935005 0.05277130
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 523.1585
...
##      AIC     AICc      BIC     BICc 
## 1052.317 1052.548 1060.363 1060.904 
## 
## Forecast errors:
## ME: -4.875; MAE: 22.802; RMSE: 26.854
## sCE: -5.555%; Asymmetry: -24.1%; sMAE: 2.165%; sMSE: 0.065%
## MASE: 0.714; RMSSE: 0.684; rMAE: 0.794; rRMSE: 0.779
\end{verbatim}
...
## Distribution assumed in the model: Normal
## Loss function type: likelihood; Loss function value: 624.918
## Persistence vector g:
##  alpha 
## 0.1709 
## 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1255.836 1256.067 1263.882 1264.423 
## 
## Forecast errors:
## ME: 75.038; MAE: 85.567; RMSE: 96.343
## sCE: 108.691%; Asymmetry: 89.8%; sMAE: 10.329%; sMSE: 1.352%
## MASE: 1.003; RMSSE: 0.934; rMAE: 1.072; rRMSE: 1.058
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.677122854  15.432067664 478.265566209  -0.016437299   0.033653459 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.259533106   0.058790526   0.006941216   0.640760971   0.697982694 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.203053522   0.212371524   0.079772218  -0.229708873   2.156266601
\end{verbatim}
...
\hypertarget{several-examples-of-state-space-arima-in-adam}{%
\subsection{Several examples of State Space ARIMA in ADAM}\label{several-examples-of-state-space-arima-in-adam}}
...
\begin{equation*}
    \begin{aligned}
        &(1-B)^2 y_t = (1 + \theta_1 B + \theta_1 B^2) \epsilon_t \\
        &\text{or} \\
...
\begin{equation*}
    \begin{aligned}
        &(1-B) (1-\phi_1 B) y_t = (1 + \theta_1 B + \theta_1 B^2) \epsilon_t \\
        &\text{or} \\
...
logARIMA(0,1,1). This model is equivalent to ARIMA applied to the \(\log y_t\). It can be written as:
\begin{equation*}
    \begin{aligned}
...
\begin{remark}
The part \(\frac{1}{2} \sum_{t=1}^T \frac{\epsilon_t^2}{\sigma^2}\) does not contain \(\mu_{y,t}\) because when inserted in the formula of Normal distribution, the numerator is: \(y_t - \mu_{y,t}\), which is based on \eqref{eq:ETSADAMNormalDistributionExample02} is \(\mu_{y,t} \epsilon_t\). After inserting in the formula for the Normal distribution that part becomes: \(\frac{1}{2} \sum_{t=1}^T \frac{(\mu_{y,t} \epsilon_t)^2}{\mu_{y,t}^2\sigma^2}\) which after cancellations leads to \eqref{eq:ETSADAMNormalDistributionExample04}.
\end{remark}
...
## 141 257.6663           254.9217            260.4649
## 142 257.7389           253.3773            262.0927
## 143 257.7869           251.8947            263.6714
## 144 257.8303           250.3168            265.3774
## 145 257.8738           248.8112            266.9873
## 146 257.9214           247.2686            268.6354
## 147 257.9619           245.7432            270.3173
## 148 258.0176           244.0555            272.0298
## 149 258.0716           242.5263            273.7594
## 150 258.1295           240.9059            275.5226
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.025  0.003  0.003  0.019 -0.023
## beta   0.003  0.011 -0.002 -0.020  0.029
## phi    0.003 -0.002  0.012  0.048 -0.049
## level  0.019 -0.020  0.048  0.513 -0.687
## trend -0.023  0.029 -0.049 -0.687  1.011
\end{verbatim}
