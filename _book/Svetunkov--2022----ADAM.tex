...
Figure \ref{fig:adamExampleNormal} shows an example with a well-behaved demand, for which the best point forecast is the straight line. To capture the uncertainty of demand, we can construct the prediction interval, which will tell which bound the demand will lie in \(1-\alpha\) per cent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 79.84 and 118. Capturing the uncertainty correctly is important because real-life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.10170199 0.11393375 0.09366572
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.10139136 0.11376109 0.09467918
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 510.4896
## Error standard deviation: 27.713
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1026.979 1027.210 1035.026 1035.566 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: -1.9%; sCE: -21.1%; Asymmetry: -62.1%; MAPE: 2.8%
## MASE: 0.928; sMAE: 2.8%; sMSE: 0.1%; rMAE: 0.834; rRMSE: 0.841
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 643.1527
## Error standard deviation: 0.0979
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1292.305 1292.536 1300.352 1300.892 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 0.9%; sCE: 17.9%; Asymmetry: 33.6%; MAPE: 6%
## MASE: 0.68; sMAE: 6.3%; sMSE: 0.6%; rMAE: 0.735; rRMSE: 0.781
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.484219802  15.566924239 483.433318211  -0.016074372   0.033887892 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.250714427   0.059304280   0.007016217   0.646360404   0.701743482 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.204827951   0.213515799   0.077061637  -0.221483219   2.127959315
\end{verbatim}
...
Coming back to the original GARCH model, \citet{Bollerlev1986} argue that GARCH, being equivalent to ARMA, will be a stationary process if its parameters are restricted so that \(\sum_{j=1}^p a_j + \sum_{j=1}^q b_j < 0\) and \(a_j, b_j \in [0,1)\) for all \(j\). For ADAM ARIMA, this means that the model can also be applied to the data without logarithmic transform as long as these restrictions are satisfied.
...
## 141 257.6643           254.8789            260.4348
## 142 257.7349           253.3818            262.0814
## 143 257.7883           251.8946            263.6810
## 144 257.8526           250.4563            265.2451
## 145 257.9032           248.9528            266.9318
## 146 257.9537           247.4137            268.4956
## 147 258.0111           245.8756            270.1712
## 148 258.0612           244.2986            271.8007
## 149 258.1145           242.6669            273.5403
## 150 258.1607           241.0304            275.3454
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.010 -0.001  0.001  0.005 -0.011
## beta  -0.001  0.007 -0.001 -0.010  0.020
## phi    0.001 -0.001  0.010  0.042 -0.043
## level  0.005 -0.010  0.042  0.509 -0.710
## trend -0.011  0.020 -0.043 -0.710  1.075
\end{verbatim}
