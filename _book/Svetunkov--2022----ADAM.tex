...
Figure \ref{fig:adamExampleNormal} shows an example with a well-behaved demand, for which the best point forecast is the straight line. To capture the uncertainty of demand, we can construct the prediction interval, which will tell which bound the demand will lie in \(1-\alpha\) per cent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (significance level \(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 78.58 and 116.92. Capturing the uncertainty correctly is important because real-life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.06586728 0.06120839 0.05235781
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.07212990 0.06690815 0.05619021
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 523.4809
...
##      AIC     AICc      BIC     BICc 
## 1052.962 1053.193 1061.008 1061.548 
## 
## Forecast errors:
## ME: 6.218; MAE: 21.771; RMSE: 27.065
## sCE: 7.41%; Asymmetry: 15.6%; sMAE: 2.162%; sMSE: 0.072%
## MASE: 0.728; RMSSE: 0.724; rMAE: 0.534; rRMSE: 0.599
\end{verbatim}
...
## Distribution assumed in the model: Normal
## Loss function type: likelihood; Loss function value: 671.8436
## Persistence vector g:
##  alpha 
## 0.1639 
## 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1349.687 1349.918 1357.734 1358.274 
## 
## Forecast errors:
## ME: 225.552; MAE: 234.358; RMSE: 270.363
## sCE: 232.267%; Asymmetry: 94.5%; sMAE: 20.111%; sMSE: 5.383%
## MASE: 1.757; RMSSE: 1.617; rMAE: 1.634; rRMSE: 1.555
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.525652368  15.568808431 481.510325412  -0.016140434   0.033889260 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.252608541   0.059311458   0.006988308   0.646438638   0.700346399 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.204852743   0.213090717   0.077643827  -0.212382775   2.088184973
\end{verbatim}
...
\begin{equation}
    \ell(\boldsymbol{\theta}, {\sigma}^2 | \mathbf{y}) = -\frac{T}{2} \log(2 \pi \mu_{y,t}^2 \sigma^2) -\frac{1}{2} \sum_{t=1}^T \frac{\epsilon_t^2}{\mu_{y,t}^2 \sigma^2} .
...
## 141 257.6785           254.8843            260.4457
## 142 257.7257           253.3456            262.1611
## 143 257.7776           251.8542            263.7122
## 144 257.8372           250.3496            265.4111
## 145 257.8965           248.8307            267.0723
## 146 257.9468           247.3123            268.6924
## 147 257.9872           245.7591            270.3888
## 148 258.0210           244.1603            272.0644
## 149 258.0519           242.6170            273.8423
## 150 258.0907           240.9174            275.6254
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.013  0.003  0.001  0.007 -0.007
## beta   0.003  0.005  0.001 -0.004  0.012
## phi    0.001  0.001  0.011  0.047 -0.051
## level  0.007 -0.004  0.047  0.494 -0.678
## trend -0.007  0.012 -0.051 -0.678  1.003
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 18 units, while the upper bound of the interval was approximately 48. Based on that upper bound, we could place an order (based on what we already have in stock) and have an appropriate safety stock.
