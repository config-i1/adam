...
Figure \ref{fig:adamExampleNormal} shows an example with a well-behaved demand, for which the best point forecast is the straight line. To capture the uncertainty of demand, we can construct the prediction interval, which will tell which bound the demand will lie in \(1-\alpha\) per cent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (significance level \(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 78.12 and 122.47. Capturing the uncertainty correctly is important because real-life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05801692 0.06422228 0.06928010
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05168418 0.05861529 0.06237891
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 528.4991
## Error standard deviation: 32.742
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1062.998 1063.229 1071.045 1071.585 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: 1.9%; sCE: 25.8%; Asymmetry: 59.2%; MAPE: 3.7%
## MASE: 1.148; sMAE: 4%; sMSE: 0.2%; rMAE: 1.211; rRMSE: 1.128
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 662.9643
## Error standard deviation: 0.0953
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1331.929 1332.159 1339.975 1340.515 
## 
## 95% parametric prediction interval was constructed
## 75% of values are in the prediction interval
## Forecast errors:
## MPE: -17.4%; sCE: -198.7%; Asymmetry: -100%; MAPE: 17.4%
## MASE: 1.822; sMAE: 16.6%; sMSE: 3.3%; rMAE: 1.536; rRMSE: 1.497
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -4.926967430  15.530677754 478.688692655  -0.014894040   0.033698667 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.225239297   0.059166194   0.006947357   0.644855400   0.698291382 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.204351023   0.212465447   0.069231392  -0.164189668   1.986142837
\end{verbatim}
...
## 141 257.6575           254.8921            260.4714
## 142 257.7199           253.3190            262.1298
## 143 257.7750           251.7871            263.7453
## 144 257.8278           250.2646            265.3996
## 145 257.8885           248.7275            267.0524
## 146 257.9452           247.2242            268.7036
## 147 258.0056           245.7451            270.4633
## 148 258.0585           244.1488            272.1120
## 149 258.1138           242.4205            273.8120
## 150 258.1613           240.7491            275.6734
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.026  0.003  0.002  0.021 -0.027
## beta   0.003  0.008 -0.001 -0.015  0.025
## phi    0.002 -0.001  0.014  0.070 -0.074
## level  0.021 -0.015  0.070  0.590 -0.747
## trend -0.027  0.025 -0.074 -0.747  1.021
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 24 units, while the upper bound of the interval was approximately 29. Based on that upper bound, we could place an order (based on what we already have in stock) and have an appropriate safety stock.
