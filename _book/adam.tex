...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 84.16 and 119.02. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.07706845 0.08003685 0.08435715
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.07359501 0.07455341 0.07708551
\end{verbatim}
...
From statistical point of view, formulae in Tables \ref{tab:ETSAdditiveError} and \ref{tab:ETSMultiplicativeError} correspond to the ``true models'' \citep[see Section 1.2 of][]{SvetunkovSBA}, describing how components evolve over time and how the actual values are formed. When constructing these models, the values of components and parameters should be substituted by their estimates (e.g.~\(\hat{l}_t\) instead of \(l_t\)). However, if the values of parameters of these models were known, then it would be possible to produce point forecasts and conditional h steps ahead expectations from these models. Tables \ref{tab:ETSAdditiveErrorForecasts} and\ref{tab:ETSMultiplicativeErrorForecasts} summarise:
...
\textbf{Not all the point forecasts of ETS models correspond to conditional expectations}. This issue applies to the models with multiplicative trend and / or multiplicative seasonality. This is because ETS model assumes that different states are correlated (they have the same source of error) and as a result multiple steps ahead values (when h\textgreater1) of states introduce products of error terms. So, the conditional expectations in these cases might not have analytical forms (``n.c.f.'' in Tables \ref{tab:ETSAdditiveErrorForecasts} and\ref{tab:ETSMultiplicativeErrorForecasts} stands for ``no closed form''), and when working with these models, simulations might be required. This does not apply to the one step ahead forecasts, for which all the classical formulae work.

\end{remark}

\begin{table}

\caption{\label{tab:ETSAdditiveErrorForecasts}Point forecasts and expectations of additive error ETS models. n.c.f. stands for "No Closed Form".}
\centering
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{l|l|l|l}
\hline
...
\caption{\label{tab:ETSMultiplicativeErrorForecasts}Point forecasts and expectations of multiplicative error ETS models. n.c.f. stands for "No Closed Form".}
\centering
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{l|l|l|l}
\hline
...
## 
## Loss function type: likelihood; Loss function value: 520.058
## Error standard deviation: 30.2803
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1046.116 1046.347 1054.162 1054.703 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: 4%; sCE: 48.9%; Asymmetry: 96%; MAPE: 4%
## MASE: 1.287; sMAE: 4.1%; sMSE: 0.2%; rMAE: 1.479; rRMSE: 1.589
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 666.8154
## Error standard deviation: 0.1052
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1339.631 1339.862 1347.677 1348.217 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: 10%; sCE: 142.2%; Asymmetry: 82.4%; MAPE: 12.4%
## MASE: 1.365; sMAE: 13.9%; sMSE: 3%; rMAE: 0.657; rRMSE: 0.701
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-32-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-38-1.pdf}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.475198420  15.511483108 480.899532844  -0.016036904   0.033780506 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.250302009   0.059093070   0.006979444   0.644058411   0.699902066 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.204098462   0.212955522   0.076934872  -0.218485233   2.127770496
\end{verbatim}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-61}{}{\label{exm:unnamed-chunk-61} }All birds have wings. Sarah has wings. Thus Sarah is a bird.
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-65-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-74-1.pdf}
...
## 0.1325 0.9792 
## 
## Error standard deviation: 2.4457
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
##  96.2031  96.5840 107.0050 107.9003
\end{verbatim}
...
## 30.8759  0.8894 
## 
## Error standard deviation: 4.3048
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 102.1270 102.5079 112.9289 113.8242
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 102.2484 103.0640 118.4513 120.3680
\end{verbatim}
...
## 0.3431 
## 
## Error standard deviation: 2.9272
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##     AIC    AICc     BIC    BICc 
## 94.2484 94.3606 99.6494 99.9130
\end{verbatim}
...
## 0.224 1.007 
## 
## Error standard deviation: 1.4328
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 104.9490 105.3300 115.7510 116.6463
\end{verbatim}
...
##           381.0916           381.2516           380.2052           390.5866
\end{verbatim}
...
## 0.0612 1.1061 
## 
## Error standard deviation: 1.5217
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
##  96.9709  97.5478 110.4733 111.8292
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 149.9267
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.0178 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 398.8243 399.6399 415.0272 416.9439 
## 
## Forecast errors:
## Asymmetry: 45.535%; sMSE: 41.644%; rRMSE: 0.867; sPIS: -1307.99%; sCE: 284.419%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 135.2094
## Persistence vector g:
## alpha  beta 
##     0     0 
## Damping parameter: 0.9978
## Sample size: 110
## Number of estimated parameters: 6
## Number of degrees of freedom: 104
## Number of provided parameters: 5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 369.3896 370.2052 385.5925 387.5092 
## 
## Forecast errors:
## Asymmetry: -63.023%; sMSE: 44.054%; rRMSE: 0.892; sPIS: 1715.889%; sCE: -334.773%
\end{verbatim}
...
## Occurrence model type: Direct
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 164.7009
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.4079 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 424.3727 424.7536 435.1746 436.0699 
## 
## Forecast errors:
## Asymmetry: 37.616%; sMSE: 37.499%; rRMSE: 0.823; sPIS: -933.139%; sCE: 211.088%
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-184-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-185-1.pdf}
...
## 141 257.6577           254.9196            260.3682
## 142 257.7109           253.4136            262.0846
## 143 257.7776           251.9904            263.6798
## 144 257.8216           250.4362            265.2126
## 145 257.8721           248.9700            266.7917
## 146 257.9166           247.4758            268.4402
## 147 257.9681           245.7792            270.1197
## 148 258.0102           244.2646            271.7791
## 149 258.0569           242.5546            273.3720
## 150 258.0989           240.8705            275.2390
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.014  0.004  0.003  0.010 -0.010
## beta   0.004  0.005  0.001 -0.001  0.008
## phi    0.003  0.001  0.011  0.048 -0.051
## level  0.010 -0.001  0.048  0.503 -0.703
## trend -0.010  0.008 -0.051 -0.703  1.073
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-195-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-205-1.pdf}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 25 units, while the upper bound of the interval was approximately 40. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
