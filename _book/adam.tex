...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 83.46 and 119.63. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.09721109 0.09024645 0.07802022
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.10238902 0.09390090 0.08043844
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 525.6616
## Error standard deviation: 31.8929
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1057.323 1057.554 1065.370 1065.910 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 1.9%; sCE: 23.7%; Asymmetry: 66.1%; MAPE: 2.9%
## MASE: 0.944; sMAE: 2.9%; sMSE: 0.1%; rMAE: 0.902; rRMSE: 0.893
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 606.0925
## Error standard deviation: 0.0969
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1218.185 1218.416 1226.231 1226.772 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: -2.2%; sCE: -1.8%; Asymmetry: -3%; MAPE: 12.6%
## MASE: 1.301; sMAE: 11.9%; sMSE: 1.9%; rMAE: 1; rRMSE: 0.989
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -6.208121043  15.432678942 482.730046719  -0.017547396   0.033750270 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.283808010   0.058792855   0.007006011   0.640786352   0.701232868 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.203061565   0.213360438   0.087233551  -0.270572764   2.297985724
\end{verbatim}
...
\begin{equation}
  \begin{aligned}
    & {y}_{t} = \mathbf{w}'_{1} \mathbf{v}_{1,t-\mathbf{l}} + \mathbf{x}'_{t} \mathbf{v}_{2,t-1} + \epsilon_t \\
    & \mathbf{v}_{1,t} = \mathbf{F_1} \mathbf{v}_{1,t-\mathbf{l}} + \mathbf{g} \epsilon_t
    & \mathbf{v}_{2,t} = \mathbf{v}_{2,t-1}
  \end{aligned} ,
  \label{eq:ETSXADAMStateSpacePureAdditiveFullAlternative}
\end{equation}
where \(\mathbf{v}'_{1,t}\) contains the conventional components of ADAM and \(\mathbf{v}_{2,t}\) contains the parameters for the explanatory variables.
...
\hypertarget{the-adamx-with-deterministic-explanatory-variables}{%
\subsection{The ADAMX with deterministic explanatory variables}\label{the-adamx-with-deterministic-explanatory-variables}}
...
\hypertarget{deterministic-explanatory-variables}{%
\subsection{Deterministic explanatory variables}\label{deterministic-explanatory-variables}}
...
\hypertarget{stochastic-explanatory-variables}{%
\subsection{Stochastic explanatory variables}\label{stochastic-explanatory-variables}}
...
## 0.6727 
## 
## Error standard deviation: 1.0871
## Sample size: 110
## Number of estimated parameters: 1
## Number of degrees of freedom: 109
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 141.0907 141.1277 143.7912 143.8782
\end{verbatim}
...
The plot above demonstrates the dynamics of the occurrence variable \(o_t\) and the fitted and predicted probabilities. The oETS\(_F\) model produces the straight line for the probability of 0.67, ignoring the fact that in our example the probability of occurrence has increased over time.
...
## 0.2239 1.0133 
## 
## Error standard deviation: 1.6505
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 108.2730 108.6539 119.0749 119.9702
\end{verbatim}
...
## 12.7052  0.8892 
## 
## Error standard deviation: 3.107
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 112.3209 112.7018 123.1228 124.0181
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 111.6909 112.5064 127.8938 129.8105
\end{verbatim}
...
## 1.1359 
## 
## Error standard deviation: 1.4245
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 103.6909 103.8030 109.0918 109.3554
\end{verbatim}
...
## 0.2889 1.0145 
## 
## Error standard deviation: 0.8357
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 106.7460 107.1269 117.5479 118.4432
\end{verbatim}
...
##           390.7504           394.1335           388.0467           400.2580
\end{verbatim}
...
## 0.1348 1.0549 
## 
## Error standard deviation: 1.094
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 109.8305 110.4075 123.3329 124.6888
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 132.2296
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.1411 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 376.2897 377.1052 392.4926 394.4093 
## 
## Forecast errors:
## Asymmetry: 83.485%; sMSE: 102.709%; rRMSE: 1.13; sPIS: -3967.824%; sCE: 641.471%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 132.7003
## Persistence vector g:
## alpha  beta 
## 1e-04 0e+00 
## Damping parameter: 0.9974
## Sample size: 110
## Number of estimated parameters: 6
## Number of degrees of freedom: 104
## Number of provided parameters: 5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 377.2311 378.0467 393.4340 395.3507 
## 
## Forecast errors:
## Asymmetry: 4.819%; sMSE: 66.121%; rRMSE: 0.907; sPIS: -1264.151%; sCE: 108.767%
\end{verbatim}
...
## Occurrence model type: Direct
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 152.7414
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.0896 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 413.3133 413.6943 424.1152 425.0106 
## 
## Forecast errors:
## Asymmetry: 84.057%; sMSE: 107.314%; rRMSE: 1.155; sPIS: -4138.659%; sCE: 669.664%
\end{verbatim}
...
## 141 257.6588           254.8881            260.4015
## 142 257.7038           253.3676            262.0324
## 143 257.7504           251.8174            263.6988
## 144 257.7931           250.4291            265.2550
## 145 257.8331           248.8391            266.8482
## 146 257.8799           247.3883            268.4339
## 147 257.9257           245.8523            270.2019
## 148 257.9693           244.2277            271.8356
## 149 257.9999           242.5780            273.6783
## 150 258.0362           241.0316            275.4140
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.016  0.000  0.002  0.011 -0.015
## beta   0.000  0.009 -0.002 -0.017  0.024
## phi    0.002 -0.002  0.013  0.057 -0.060
## level  0.011 -0.017  0.057  0.563 -0.743
## trend -0.015  0.024 -0.060 -0.743  1.059
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 15 units, while the upper bound of the interval was approximately 32. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
