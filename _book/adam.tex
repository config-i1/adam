...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 81.95 and 118.48. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.07975360 0.08120570 0.08292167
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.07926888 0.08066191 0.08241755
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 526.7481
## Error standard deviation: 32.2154
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1059.496 1059.727 1067.543 1068.083 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 0.9%; sCE: 11.4%; Asymmetry: 43.3%; MAPE: 2.2%
## MASE: 0.669; sMAE: 2.2%; sMSE: 0.1%; rMAE: 0.744; rRMSE: 0.731
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 656.198
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1318.396 1318.627 1326.442 1326.983 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 4.1%; sCE: 79.4%; Asymmetry: 59.5%; MAPE: 8.9%
## MASE: 1.193; sMAE: 11.9%; sMSE: 2.3%; rMAE: 0.962; rRMSE: 0.995
\end{verbatim}
...
The prediction interval in this case is slightly wider than in the previous one, because \(\mathcal{GN}\) distribution with \(\beta=\) 1.87 has fatter tails than the normal distribution (Figure \ref{fig:BJsalesAANForecastGN}).
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.240812646  15.134965973 456.499457428  -0.015475312   0.032964297 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.239586921   0.057658677   0.006625318   0.628424895   0.681914980 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.199144289   0.207482685   0.073641395  -0.196226338   1.946829071
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##   28.03318586   36.90735860 2419.15709505    0.04810873    0.07016154 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##    1.28155405    0.14060352    0.03510998    1.53244500    1.56979208 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##    0.48562314    0.47763238    0.39390893    0.70056034   -7.19709463
\end{verbatim}
...
Based on that, we can conclude that the introduction of the law reduced on average the number of incidents by approximately 24\%, while the increase of the petrol price by 1\% leads on average to decrease in the number of incidents by 0.28\%. Finally, the distance has a negative impact on incidents as well, reducing it on average by 0.1\% for each 1\% increase in the distance. All of this is the standard interpretation of parameters, which we can use based on the estimated model \citep[see, for example, discussion in Section 8.3 of][]{SvetunkovSBA}. We will discuss how to do the analysis using ADAM in Chapter \ref{ADAMUncertainty}, introducing the standard errors and confidence intervals for the parameters.
...
## 0.0802 1.0405 
## 
## Error standard deviation: 2.4423
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 104.1864 104.5673 114.9883 115.8836
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 107.9361 108.7517 124.1390 126.0557
\end{verbatim}
...
## 0.934 
## 
## Error standard deviation: 2.4291
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
##  99.9361 100.0483 105.3371 105.6007
\end{verbatim}
...
## 0.2346 1.0111 
## 
## Error standard deviation: 1.2327
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 109.9261 110.3070 120.7280 121.6233
\end{verbatim}
...
##           360.3455           361.3054           355.2803           370.2620
\end{verbatim}
...
## 0.0463 1.1344 
## 
## Error standard deviation: 1.4784
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 103.5338 104.1107 117.0362 118.3921
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 128.2975
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.4292 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 362.1289 362.9445 378.3318 380.2485 
## 
## Forecast errors:
## Asymmetry: -69.924%; sMSE: 45.433%; rRMSE: 1.061; sPIS: 3142.648%; sCE: -378.107%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 119.4655
## Persistence vector g:
##  alpha   beta 
## 0.0135 0.0000 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 344.4647 345.2803 360.6676 362.5843 
## 
## Forecast errors:
## Asymmetry: -89.499%; sMSE: 56.571%; rRMSE: 1.184; sPIS: 3876.41%; sCE: -575.919%
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{adam_files/figure-latex/adamARIMAModelFitExample-1.pdf}
...
\begin{figure}
\centering
\includegraphics{adam_files/figure-latex/adamETSCCNAAdN-1.pdf}
...
## 141 257.6533           254.9166            260.3715
## 142 257.7078           253.3776            262.0361
## 143 257.7610           251.9120            263.6585
## 144 257.8150           250.4552            265.2065
## 145 257.8699           248.9631            266.8107
## 146 257.9187           247.4153            268.5128
## 147 257.9695           245.8528            270.2206
## 148 258.0218           244.3325            271.8930
## 149 258.0801           242.7320            273.7661
## 150 258.1443           241.1228            275.5964
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.019 -0.007  0.005  0.022  0.001
## beta  -0.007  0.010 -0.006 -0.043 -0.012
## phi    0.005 -0.006  0.011  0.092  0.004
## level  0.022 -0.043  0.092  1.197 -0.155
## trend  0.001 -0.012  0.004 -0.155  0.136
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{adam_files/figure-latex/adamModelBJAAdN-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-144-1.pdf}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 22 units, while the upper bound of the interval was approximately 24. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
