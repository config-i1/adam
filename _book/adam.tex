...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 76.49 and 122.26. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\hypertarget{aggregating-error-measures}{%
\subsection{Aggregating error measures}\label{aggregating-error-measures}}
...
\tightlist
\item
  RMSSE - Root Mean Squared Scaled Error \citep{Makridakis2020}:
  \begin{equation}
...
\NormalTok{  model1 }\OtherTok{\textless{}{-}} \FunctionTok{es}\NormalTok{(y,}\StringTok{"ANN"}\NormalTok{,}\AttributeTok{h=}\DecValTok{10}\NormalTok{,}\AttributeTok{holdout=}\ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  errorMeasures[i,}\DecValTok{1}\NormalTok{,] }\OtherTok{\textless{}{-}} \FunctionTok{measures}\NormalTok{(model1}\SpecialCharTok{$}\NormalTok{holdout, model1}\SpecialCharTok{$}\NormalTok{forecast,}
                                  \FunctionTok{actuals}\NormalTok{(model1))}
  \CommentTok{\# Apply CES}
\NormalTok{  model2 }\OtherTok{\textless{}{-}} \FunctionTok{ces}\NormalTok{(y,}\AttributeTok{h=}\DecValTok{10}\NormalTok{,}\AttributeTok{holdout=}\ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  errorMeasures[i,}\DecValTok{2}\NormalTok{,] }\OtherTok{\textless{}{-}} \FunctionTok{measures}\NormalTok{(model2}\SpecialCharTok{$}\NormalTok{holdout, model2}\SpecialCharTok{$}\NormalTok{forecast,}
                                  \FunctionTok{actuals}\NormalTok{(model2))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
Based on the values above, we cannot make any solid conclusion about the performance of the two models: in terms of mean rRMSE, CES is doing slightly better, while in terms of median values the ETS is outperforming its competitor. This tells us that CES does not produce as big errors as ETS does, but the difference between the two models is not substantial so we can probably choose the one that is easier to work with (i.e.~ETS).
...
\begin{verbatim}
##         h1         h2         h3 
## 0.09160918 0.06616105 0.07399004
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.09626478 0.07105095 0.07397976
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-17-1.pdf}
...
## 
## Loss function type: likelihood; Loss function value: 530.9715
## Error standard deviation: 33.5001
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1067.943 1068.174 1075.989 1076.530 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: -3.6%; sCE: -39.8%; Asymmetry: -91.8%; MAPE: 3.8%
## MASE: 1.074; sMAE: 3.6%; sMSE: 0.2%; rMAE: 1.188; rRMSE: 1.28
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 669.5925
## Error standard deviation: 0.099
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1345.185 1345.416 1353.231 1353.772 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 7.4%; sCE: 114.5%; Asymmetry: 88.6%; MAPE: 8.4%
## MASE: 1.049; sMAE: 10.6%; sMSE: 1.6%; rMAE: 0.75; rRMSE: 0.786
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -4.432698628  15.236200400 452.727546350  -0.013795028   0.032992052 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.202643500   0.058044343   0.006570575   0.632628289   0.679091912 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.200476321   0.206623725   0.062286163  -0.132001926   1.745663717
\end{verbatim}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-62}{}{\label{exm:unnamed-chunk-62} }All birds have wings. Sarah has wings. Thus Sarah is a bird.
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-84-1.pdf}
...
## 0.5008 0.9739 
## 
## Error standard deviation: 1.4773
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 122.8991 123.2801 133.7010 134.5964
\end{verbatim}
...
## 6.4427 0.9136 
## 
## Error standard deviation: 3.3762
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 126.8323 127.2132 137.6342 138.5295
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 131.8852 132.7007 148.0881 150.0048
\end{verbatim}
...
## 0.9721 
## 
## Error standard deviation: 1.4121
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 123.8852 123.9973 129.2862 129.5497
\end{verbatim}
...
## 0.5822 1.0695 
## 
## Error standard deviation: 2.1195
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 677.6094 677.9904 688.4114 689.3067
\end{verbatim}
...
##           460.3000           460.3555           454.9333           469.8230
\end{verbatim}
...
## 0.1639 1.0417 
## 
## Error standard deviation: 1.077
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 122.5157 123.0926 136.0181 137.3740
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 148.2296
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.1924 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 420.9749 421.7905 437.1778 439.0945 
## 
## Forecast errors:
## Asymmetry: 23.437%; sMSE: 83.823%; rRMSE: 0.815; sPIS: -1301.271%; sCE: 311.391%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 159.801
## Persistence vector g:
##  alpha   beta 
## 0.1537 0.0065 
## Damping parameter: 0.4279
## Sample size: 110
## Number of estimated parameters: 6
## Number of degrees of freedom: 104
## Number of provided parameters: 5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 444.1177 444.9333 460.3206 462.2373 
## 
## Forecast errors:
## Asymmetry: -14.838%; sMSE: 74.356%; rRMSE: 0.768; sPIS: 139.802%; sCE: 46.629%
\end{verbatim}
...
## Occurrence model type: Direct
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 167.1324
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.0418 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 454.7805 455.1615 465.5825 466.4778 
## 
## Forecast errors:
## Asymmetry: 28.18%; sMSE: 85.393%; rRMSE: 0.823; sPIS: -1448.461%; sCE: 335.65%
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-174-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-186-1.pdf}
...
## 141 257.6591           254.9436            260.3951
## 142 257.7187           253.3990            262.0748
## 143 257.7626           251.9432            263.6303
## 144 257.8069           250.4677            265.1725
## 145 257.8445           248.9716            266.7394
## 146 257.8994           247.4178            268.4279
## 147 257.9429           245.8297            270.1139
## 148 257.9832           244.2555            271.8616
## 149 258.0249           242.7486            273.6224
## 150 258.0517           241.0751            275.2380
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.026 -0.004  0.006  0.027  0.001
## beta  -0.004  0.005 -0.002 -0.034  0.002
## phi    0.006 -0.002  0.009  0.086 -0.008
## level  0.027 -0.034  0.086  1.263 -0.214
## trend  0.001  0.002 -0.008 -0.214  0.081
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-196-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-206-1.pdf}
