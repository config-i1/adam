...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 78.02 and 119.14. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
Another option for producing forecasts from 8 origins would be to start from origin 17 instead of 15, as shown in Figure \ref{fig:ROProcessNoCO}. In this case the procedure continues until origin 22 when the last full set of three-steps-ahead forecasts can be produced but then continues with a decreasing forecasting horizon. So the two-steps-ahead forecast is produced from origin 23 and only a one-step-ahead forecast is produced from origin 24. As a result we obtain 8 one-step-ahead forecasts, 7 two-steps-ahead forecasts and 6 three-steps-ahead forecasts. This is a rolling origin with a \textbf{non-constant holdout} sample size, which can be useful with small samples when we don't have any observations to spare.
...
## 
## Loss function type: likelihood; Loss function value: 533.8837
## Error standard deviation: 34.4157
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1073.767 1073.998 1081.814 1082.354 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 1.1%; sCE: 14.1%; Asymmetry: 39.3%; MAPE: 2.6%
## MASE: 0.805; sMAE: 2.6%; sMSE: 0.1%; rMAE: 0.547; rRMSE: 0.56
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 630.2355
## Error standard deviation: 0.1086
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1266.471 1266.702 1274.517 1275.058 
## 
## 95% parametric prediction interval was constructed
## 83% of values are in the prediction interval
## Forecast errors:
## MPE: 12.1%; sCE: 203.8%; Asymmetry: 88.2%; MAPE: 12.9%
## MASE: 1.755; sMAE: 17.9%; sMSE: 5.2%; rMAE: 0.772; rRMSE: 0.822
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.241639762  14.980081556 453.013001929  -0.015430464   0.032635971 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.239624733   0.057068624   0.006574718   0.621993878   0.679305970 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.197106336   0.206688856   0.073653018  -0.211090875   1.973383655
\end{verbatim}
...
## 0.3762 0.9254 
## 
## Error standard deviation: 1.5521
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 104.6125 104.9935 115.4144 116.3098
\end{verbatim}
...
## 8.3388 0.9018 
## 
## Error standard deviation: 4.2302
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 104.0160 104.3970 114.8179 115.7133
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 105.5176 106.3331 121.7205 123.6372
\end{verbatim}
...
## 0.2584 
## 
## Error standard deviation: 1.3415
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
##  97.5176  97.6298 102.9186 103.1822
\end{verbatim}
...
## 0.3218 1.0135 
## 
## Error standard deviation: 0.7695
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 100.6560 101.0370 111.4579 112.3533
\end{verbatim}
...
##           386.4129           387.7981           388.6160           403.7190
\end{verbatim}
...
## 0.3867 0.9976 
## 
## Error standard deviation: 1.3277
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 103.0315 103.6084 116.5339 117.8898
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 145.392
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.2073 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 395.8156 396.6311 412.0184 413.9351 
## 
## Forecast errors:
## Asymmetry: 100%; sMSE: 229.534%; rRMSE: 0.649; sPIS: -6249.385%; sCE: 1280.987%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 135.2829
## Persistence vector g:
##  alpha   beta 
## 0.0053 0.0040 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 375.5973 376.4129 391.8002 393.7169 
## 
## Forecast errors:
## Asymmetry: 56.838%; sMSE: 84.019%; rRMSE: 0.393; sPIS: -1713.907%; sCE: 414.579%
\end{verbatim}
...
## Occurrence model type: Odds ratio
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 152.0531
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.0426 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 405.1377 405.5187 415.9397 416.8350 
## 
## Forecast errors:
## Asymmetry: 100%; sMSE: 260.852%; rRMSE: 0.692; sPIS: -6823.473%; sCE: 1388.617%
\end{verbatim}
...
## 141 257.6678           254.9167            260.4024
## 142 257.7203           253.3494            262.0718
## 143 257.7696           251.8963            263.7026
## 144 257.8334           250.4354            265.3039
## 145 257.8822           248.9154            266.9276
## 146 257.9268           247.3575            268.5939
## 147 257.9618           245.8260            270.3562
## 148 257.9976           244.2919            272.0615
## 149 258.0352           242.6727            273.7380
## 150 258.0758           241.0843            275.4570
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.041 -0.007  0.010  0.052  0.003
## beta  -0.007  0.009 -0.004 -0.042 -0.003
## phi    0.010 -0.004  0.011  0.084  0.002
## level  0.052 -0.042  0.084  1.043 -0.112
## trend  0.003 -0.003  0.002 -0.112  0.077
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 20 units, while the upper bound of the interval was approximately 34. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
