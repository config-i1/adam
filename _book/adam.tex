...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 81.39 and 120.05. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.10847725 0.09717516 0.09621178
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.11244024 0.09728020 0.09717657
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 525.5286
## Error standard deviation: 31.8537
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1057.057 1057.288 1065.103 1065.644 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 3%; sCE: 34%; Asymmetry: 67.8%; MAPE: 4.5%
## MASE: 1.268; sMAE: 4.2%; sMSE: 0.2%; rMAE: 0.958; rRMSE: 0.955
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 659.839
## Error standard deviation: 0.1006
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1325.678 1325.909 1333.724 1334.265 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: 9.4%; sCE: 125.9%; Asymmetry: 91%; MAPE: 10.6%
## MASE: 1.112; sMAE: 11.5%; sMSE: 2%; rMAE: 1.485; rRMSE: 1.469
\end{verbatim}
...
\begin{equation}
  ...
  \label{eq:ETSAANForecast}
\end{equation}
where \(\lceil\frac{h}{m}\rceil\) is the rounded up value of the fraction in the brackets. The point forecast from this model is shown in Figure \ref{fig:}
...
When it comes to the selection of the most appropriate model, the conventional approach involves the application of all models to the data and then selecting the most appropriate of them based on an information cretiria (see Section 13.4 of \citet{SvetunkovSBA}). This was first proposed by \citet{Hyndman2002}. In case of the conventional ETS model, this relies on the likelihood value of normal distribution, used in the estimation of the model.
...
\item
  ...
  \begin{equation}
    \begin{aligned}
    & {l}_{t} = l_{t-1} b_{t-1} + \alpha\epsilon_t l_{t-1} b_{t-1} \\
    & b_t = b_{t-1} + \beta\epsilon_t b_{t-1}\\
    & s_t = s_{t-m} +\gamma\epsilon_t s_{t-m}
    \end{aligned},
...
\begin{equation}
  ...
  & \mathbf{v}_{t} = \mathbf{F} \mathbf{v}_{t-1} + g \epsilon_t
  \end{aligned},
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.565822664  15.453814063 478.627964829  -0.016190466   0.033688005 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.254444951   0.058873372   0.006946476   0.641663912   0.698247087 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.203339659   0.212451970   0.078208281  -0.224983841   2.122494866
\end{verbatim}
...
## 0.7273 
## 
## Error standard deviation: 1.0756
## Sample size: 110
## Number of estimated parameters: 1
## Number of degrees of freedom: 109
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 130.9096 130.9466 133.6101 133.6971
\end{verbatim}
...
The plot above demonstrates the dynamics of the occurrence variable \(o_t\) and the fitted and predicted probabilities. The oETS\(_F\) model produces the straight line for the probability of 0.73, ignoring the fact that in our example the probability of occurrence has increased over time.
...
## 0.2480 1.0459 
## 
## Error standard deviation: 1.3051
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 101.7473 102.1282 112.5492 113.4445
\end{verbatim}
...
## 5.7384 0.9242 
## 
## Error standard deviation: 3.8207
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 103.4221 103.8031 114.2240 115.1194
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 106.7136 107.5291 122.9164 124.8331
\end{verbatim}
...
## 1.1335 
## 
## Error standard deviation: 1.4369
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
##  98.7136  98.8257 104.1145 104.3781
\end{verbatim}
...
## 0.3975 1.0073 
## 
## Error standard deviation: 0.8082
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 105.7197 106.1007 116.5216 117.4170
\end{verbatim}
...
##           404.3717           407.5360           400.0500           418.0225
\end{verbatim}
...
## 0.2984 1.0246 
## 
## Error standard deviation: 0.7313
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 101.6694 102.2464 115.1718 116.5277
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 149.3754
## ARMA parameters of the model:
## AR:
## phi1[1] 
##  0.2596 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 402.4203 403.2358 418.6232 420.5399 
## 
## Forecast errors:
## Asymmetry: 100%; sMSE: 212.104%; rRMSE: 0.656; sPIS: -6992.207%; sCE: 1354.765%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 142.7825
## Persistence vector g:
## alpha  beta 
## 0.005 0.005 
## Damping parameter: 0.9901
## Sample size: 110
## Number of estimated parameters: 6
## Number of degrees of freedom: 104
## Number of provided parameters: 5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 389.2344 390.0500 405.4373 407.3540 
## 
## Forecast errors:
## Asymmetry: 100%; sMSE: 77.855%; rRMSE: 0.398; sPIS: -3185.714%; sCE: 680.998%
\end{verbatim}
...
## Occurrence model type: Direct
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 155.4416
## ARMA parameters of the model:
## AR:
## phi1[1] 
##  0.2487 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 410.5526 410.9336 421.3546 422.2499 
## 
## Forecast errors:
## Asymmetry: 100%; sMSE: 247.68%; rRMSE: 0.709; sPIS: -7656.518%; sCE: 1479.079%
\end{verbatim}
...
## 141 257.6604           254.9322            260.3829
## 142 257.7150           253.3802            261.9944
## 143 257.7704           251.9498            263.6051
## 144 257.8233           250.5423            265.2193
## 145 257.8648           248.9617            266.8193
## 146 257.9139           247.4710            268.4756
## 147 257.9466           245.8429            270.1689
## 148 257.9872           244.3503            271.8346
## 149 258.0194           242.7354            273.5328
## 150 258.0451           241.1043            275.3089
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.003  0.001 -0.001 -0.005  0.006
## beta   0.001  0.004 -0.002 -0.011  0.016
## phi   -0.001 -0.002  0.011  0.047 -0.052
## level -0.005 -0.011  0.047  0.482 -0.671
## trend  0.006  0.016 -0.052 -0.671  1.004
\end{verbatim}
