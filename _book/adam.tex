...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 81.17 and 120.56. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\textbf{Not all the point forecasts of ETS models correspond to conditional expectations}. This issue applies to the models with multiplicative trend and / or multiplicative seasonality. This is because ETS model assumes that different states are correlated (they have the same source of error) and as a result multiple steps ahead values (when h\textgreater1) of states introduce products of error terms. So, the conditional expectations in these cases might not have analytical forms, and when working with these models, simulations might be required. This does not apply to the one step ahead forecasts, for which all the classical formulae work.

\end{remark}

\begin{table}

\caption{\label{tab:ETSAdditiveErrorForecasts}Point forecasts and expectations of additive error ETS models}
\centering
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{l|l|l|l}
\hline
...
\caption{\label{tab:ETSMultiplicativeErrorForecasts}Point forecasts and expectations of multiplicative error ETS models}
\centering
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{l|l|l|l}
\hline
...
## 
## Loss function type: likelihood; Loss function value: 518.8808
## Error standard deviation: 29.9521
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1043.762 1043.992 1051.808 1052.348 
## 
## 95% parametric prediction interval was constructed
## 50% of values are in the prediction interval
## Forecast errors:
## MPE: 5.5%; sCE: 69.5%; Asymmetry: 100%; MAPE: 5.5%
## MASE: 1.965; sMAE: 5.8%; sMSE: 0.5%; rMAE: 0.59; rRMSE: 0.654
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 679.5897
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1365.179 1365.410 1373.226 1373.766 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 6.1%; sCE: 127%; Asymmetry: 57.5%; MAPE: 11.2%
## MASE: 1.918; sMAE: 16.8%; sMSE: 4%; rMAE: 0.982; rRMSE: 0.976
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.876974526  15.490174482 484.184264771  -0.016879665   0.033809761 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.268669446   0.059011892   0.007027116   0.643173647   0.702288301 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.203818085   0.213681569   0.082580438  -0.248253726   2.226782699
\end{verbatim}
...
## 0.1643 1.0433 
## 
## Error standard deviation: 1.7154
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 103.9171 104.2980 114.7190 115.6143
\end{verbatim}
...
## 16.0198  0.8881 
## 
## Error standard deviation: 7.3146
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 110.1354 110.5163 120.9373 121.8326
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 107.5725 108.3880 123.7754 125.6921
\end{verbatim}
...
## 1.8458 
## 
## Error standard deviation: 1.4731
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
##  99.5725  99.6846 104.9735 105.2370
\end{verbatim}
...
## 0.2899 1.0036 
## 
## Error standard deviation: 1.1412
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 113.5896 113.9706 124.3916 125.2869
\end{verbatim}
...
##           384.6096           385.8338           384.3755           397.3516
\end{verbatim}
...
## 0.1182 1.0800 
## 
## Error standard deviation: 1.0144
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 105.5684 106.1453 119.0708 120.4267
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 142.9174
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.2389 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 393.4031 394.2187 409.6060 411.5227 
## 
## Forecast errors:
## Asymmetry: -65.014%; sMSE: 84.523%; rRMSE: 0.959; sPIS: 4490.594%; sCE: -525.736%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 132.9958
## Persistence vector g:
## alpha  beta 
##     0     0 
## Damping parameter: 0.9992
## Sample size: 110
## Number of estimated parameters: 6
## Number of degrees of freedom: 104
## Number of provided parameters: 5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 373.5600 374.3755 389.7628 391.6795 
## 
## Forecast errors:
## Asymmetry: -89.434%; sMSE: 118.154%; rRMSE: 1.134; sPIS: 5958.654%; sCE: -859.061%
\end{verbatim}
...
## Occurrence model type: Direct
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 157.6857
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.3441 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 418.9398 419.3207 429.7417 430.6370 
## 
## Forecast errors:
## Asymmetry: -74.6%; sMSE: 97.259%; rRMSE: 1.029; sPIS: 5092.246%; sCE: -633.926%
\end{verbatim}
...
## 141 257.6509           254.9280            260.3984
## 142 257.7124           253.3613            262.0014
## 143 257.7572           251.8610            263.5472
## 144 257.8104           250.3882            265.1057
## 145 257.8603           248.8443            266.7404
## 146 257.9201           247.4134            268.4144
## 147 257.9747           245.8303            270.1285
## 148 258.0207           244.2771            271.8297
## 149 258.0665           242.5832            273.4914
## 150 258.1318           240.9237            275.3101
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.010 -0.002  0.001  0.009 -0.016
## beta  -0.002  0.009 -0.001 -0.017  0.029
## phi    0.001 -0.001  0.010  0.049 -0.052
## level  0.009 -0.017  0.049  0.531 -0.733
## trend -0.016  0.029 -0.052 -0.733  1.102
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 24 units, while the upper bound of the interval was approximately 36. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
