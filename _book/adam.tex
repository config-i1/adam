...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 82.21 and 119.15. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.09449619 0.12000818 0.10972845
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.09788453 0.11719272 0.11138441
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 519.5596
## Error standard deviation: 30.1409
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1045.119 1045.350 1053.166 1053.706 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 3.1%; sCE: 43.1%; Asymmetry: 96.5%; MAPE: 3.2%
## MASE: 1.371; sMAE: 3.6%; sMSE: 0.2%; rMAE: 0.901; rRMSE: 0.908
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 650.5815
## Error standard deviation: 0.0977
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1307.163 1307.394 1315.209 1315.750 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: -2.9%; sCE: -22.4%; Asymmetry: -39.5%; MAPE: 8%
## MASE: 0.724; sMAE: 7.2%; sMSE: 0.7%; rMAE: 0.698; rRMSE: 0.731
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -6.225872298  15.384907928 480.289285381  -0.017564229   0.033672429 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.284619519   0.058610865   0.006970587   0.638802833   0.699457847 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.202432999   0.212820362   0.087482983  -0.270829527   2.286797301
\end{verbatim}
...
\hline
\textbf{Inverse Gaussian} & $1+\frac{\epsilon_t}{\mu_{y,t}} \sim \mathcal{IG}(1, s)$ & $\begin{aligned} &-\frac{T}{2} \log \left(2 \pi s \left(\frac{y_t}{\mu_{y,t}}\right)^3 \right) -\\
...
\hline
\textbf{Inverse Gaussian} & $1+\epsilon_t \sim \mathcal{IG}(1, s)$ & $\begin{aligned} &-\frac{T}{2} \log \left(2 \pi s \left(1+\epsilon_{t}\right)^3 \right) -\\
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-99-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-101-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-102-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-107-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-108-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-139-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-152-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-153-1.pdf}
...
## 141 257.6688           254.9502            260.4001
## 142 257.7181           253.3917            262.0588
## 143 257.7713           251.9515            263.6427
## 144 257.8177           250.4799            265.2372
## 145 257.8732           248.9587            266.8120
## 146 257.9272           247.4579            268.4277
## 147 257.9812           245.8460            270.1475
## 148 258.0264           244.3240            271.9195
## 149 258.0688           242.7717            273.6573
## 150 258.1216           241.0765            275.4236
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.035  0.008  0.005  0.032 -0.035
## beta   0.008  0.011 -0.002 -0.015  0.023
## phi    0.005 -0.002  0.014  0.067 -0.070
## level  0.032 -0.015  0.067  0.562 -0.733
## trend -0.035  0.023 -0.070 -0.733  1.041
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 22 units, while the upper bound of the interval was approximately 44. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
