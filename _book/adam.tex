...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 83 and 117.2. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05978224 0.06153743 0.06223936
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.05388331 0.06334102 0.06326686
\end{verbatim}
...
\end{equation}
Cancelling out \(e_t\) and shifting everything by one step ahead, we obtain the error correction form \eqref{eq:SESErrorCorrection} of SES. But now, the main benefit of having the model \eqref{eq:ETSANN} instead of just the method \eqref{eq:SESErrorCorrection} is in having a flexible framework, which allows adding other components, selecting the most appropriate ones, estimating parameters in a consistent way (see Section 4.3 of \citet{SvetunkovSBA}), producing prediction intervals etc.
...
## 
## Loss function type: likelihood; Loss function value: 544.9126
## Error standard deviation: 38.116
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1095.825 1096.056 1103.871 1104.412 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: 4.5%; sCE: 54.3%; Asymmetry: 81.2%; MAPE: 5.3%
## MASE: 1.367; sMAE: 5.3%; sMSE: 0.4%; rMAE: 1.015; rRMSE: 1.018
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 681.7703
## Error standard deviation: 0.1115
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1369.541 1369.771 1377.587 1378.127 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: 8%; sCE: 116.4%; Asymmetry: 74.6%; MAPE: 11%
## MASE: 1.267; sMAE: 12.5%; sMSE: 1.8%; rMAE: 0.552; rRMSE: 0.548
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.745654714  15.500239306 479.648296893  -0.016592506   0.033803602 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.262666082   0.059050235   0.006961284   0.643591553   0.698990948 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.203950517   0.212678300   0.080735195  -0.236912533   2.158763462
\end{verbatim}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-56}{}{\label{exm:unnamed-chunk-56} }All birds have wings. Sarah has wings. Thus Sarah is a bird.
...
## 0.0978 1.0479 
## 
## Error standard deviation: 2.9132
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 109.6204 110.0014 120.4224 121.3177
\end{verbatim}
...
## 16.2098  0.9252 
## 
## Error standard deviation: 4.0093
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 113.0572 113.4382 123.8592 124.7545
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 115.1584 115.9740 131.3613 133.2780
\end{verbatim}
...
## 0.7459 
## 
## Error standard deviation: 2.6935
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 107.1584 107.2706 112.5594 112.8230
\end{verbatim}
...
## 0.2365 1.0087 
## 
## Error standard deviation: 1.382
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 117.1637 117.5446 127.9656 128.8609
\end{verbatim}
...
##           398.3758           402.6729           401.0208           448.8595
\end{verbatim}
...
## 9.4114 0.2165 
## 
## Error standard deviation: 4.5313
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 113.9107 114.4876 127.4131 128.7690
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 135.2609
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.3532 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 386.4325 387.2481 402.6354 404.5521 
## 
## Forecast errors:
## Asymmetry: -17.165%; sMSE: 98.198%; rRMSE: 0.966; sPIS: 329.21%; sCE: -73.205%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 135.8248
## Persistence vector g:
##  alpha   beta 
## 0.0226 0.0006 
## Damping parameter: 1
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 387.5603 388.3758 403.7632 405.6799 
## 
## Forecast errors:
## Asymmetry: -34.333%; sMSE: 107.607%; rRMSE: 1.011; sPIS: 1218.581%; sCE: -285.928%
\end{verbatim}
...
## Occurrence model type: Odds ratio
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 151.5457
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.1354 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 415.0021 415.3830 425.8040 426.6993 
## 
## Forecast errors:
## Asymmetry: -17.192%; sMSE: 98.365%; rRMSE: 0.966; sPIS: 336.556%; sCE: -73.747%
\end{verbatim}
...
## 141 257.6630           254.9179            260.4367
## 142 257.7282           253.3811            262.0889
## 143 257.7888           251.9169            263.6757
## 144 257.8539           250.4768            265.2435
## 145 257.9183           248.9788            266.8360
## 146 257.9664           247.4627            268.4921
## 147 258.0156           245.8947            270.1768
## 148 258.0595           244.3583            271.9245
## 149 258.1046           242.7871            273.6104
## 150 258.1472           241.1280            275.4231
\end{verbatim}
...
\begin{verbatim}
##        alpha  beta    phi  level  trend
## alpha  0.036 0.009  0.007  0.040 -0.043
## beta   0.009 0.009  0.002  0.000  0.008
## phi    0.007 0.002  0.014  0.065 -0.067
## level  0.040 0.000  0.065  0.538 -0.702
## trend -0.043 0.008 -0.067 -0.702  1.005
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-200-1.pdf}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 21 units, while the upper bound of the interval was approximately 22. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
