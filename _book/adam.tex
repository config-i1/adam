...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 74.82 and 119.53. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
\begin{verbatim}
##         h1         h2         h3 
## 0.03288589 0.02885532 0.04032109
\end{verbatim}
...
\begin{verbatim}
##         h1         h2         h3 
## 0.03287199 0.02842835 0.04027499
\end{verbatim}
...
## 
## Loss function type: likelihood; Loss function value: 525.2978
## Error standard deviation: 31.7857
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1056.596 1056.826 1064.642 1065.182 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: -2.4%; sCE: -29.5%; Asymmetry: -95.3%; MAPE: 2.5%
## MASE: 0.87; sMAE: 2.5%; sMSE: 0.1%; rMAE: 1.426; rRMSE: 1.299
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 629.311
## Error standard deviation: 0.0949
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1264.622 1264.853 1272.668 1273.209 
## 
## 95% parametric prediction interval was constructed
## 83% of values are in the prediction interval
## Forecast errors:
## MPE: 6%; sCE: 81.2%; Asymmetry: 80%; MAPE: 10.4%
## MASE: 1.031; sMAE: 9.8%; sMSE: 1.7%; rMAE: 0.834; rRMSE: 0.905
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.739176428  15.544401918 485.607428488  -0.016631667   0.033893101 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.262369923   0.059218478   0.007047771   0.645425246   0.703319662 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.204531604   0.213995376   0.080644165  -0.239426041   2.194342589
\end{verbatim}
...
The smoothing parameter for the explanatory variables (Section \ref{ADAMXDynamic}) is set to \(\hat{\delta}=0.01\) in case of additive error and \(\hat{\delta}=0\) in case of the multiplicative one. The latter is done because the model might break if some of ETS components are additive.
...
## 141 257.6731           254.8930            260.4080
## 142 257.7292           253.3501            262.0581
## 143 257.7890           251.9079            263.7114
## 144 257.8452           250.4628            265.2860
## 145 257.9069           249.0290            266.9047
## 146 257.9635           247.4813            268.5439
## 147 258.0315           245.9554            270.2801
## 148 258.0800           244.4185            271.9967
## 149 258.1262           242.8264            273.6638
## 150 258.1708           241.2379            275.4363
\end{verbatim}
...
\begin{verbatim}
##        alpha  beta    phi  level  trend
## alpha  0.044 0.010  0.007  0.040 -0.044
## beta   0.010 0.008  0.003  0.007  0.003
## phi    0.007 0.003  0.013  0.060 -0.064
## level  0.040 0.007  0.060  0.506 -0.669
## trend -0.044 0.003 -0.064 -0.669  0.967
\end{verbatim}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 23 units, while the upper bound of the interval was approximately 36. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
