...
Figure \ref{fig:adamExampleNormal} shows an example, with a well behaved demand, for which the best point forecast is the straight line. In order to capture the uncertainty of demand, we can construct the prediction interval, which will tell in which bound the demand will lie in \(1-\alpha\) percent of cases. The interval in Figure \ref{fig:adamExampleNormal} has the width of 95\% (\(\alpha=0.05\)) and shows that if the situation is repeated many times, the actual demand will be between 81.44 and 118.56. Capturing the uncertainty correctly is important, because the real life decisions need to be made based on the full information, not only on the point forecasts.
...
## 
## Loss function type: likelihood; Loss function value: 529.7037
## Error standard deviation: 33.1092
## Sample size: 108
## Number of estimated parameters: 3
## Number of degrees of freedom: 105
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1065.407 1065.638 1073.454 1073.994 
## 
## 95% parametric prediction interval was constructed
## 100% of values are in the prediction interval
## Forecast errors:
## MPE: -0.1%; sCE: -0.9%; Asymmetry: 0.5%; MAPE: 2.1%
## MASE: 0.617; sMAE: 2%; sMSE: 0.1%; rMAE: 0.49; rRMSE: 0.502
\end{verbatim}
...
## Initial values were optimised.
## 
## Loss function type: likelihood; Loss function value: 659.9488
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1325.898 1326.128 1333.944 1334.484 
## 
## 95% parametric prediction interval was constructed
## 92% of values are in the prediction interval
## Forecast errors:
## MPE: -11.7%; sCE: -115.2%; Asymmetry: -85.5%; MAPE: 12.9%
## MASE: 0.955; sMAE: 10.8%; sMSE: 1.7%; rMAE: 0.858; rRMSE: 0.865
\end{verbatim}
...
\begin{verbatim}
##            ME           MAE           MSE           MPE          MAPE 
##  -5.423855766  15.530995655 479.974987008  -0.015940114   0.033811803 
##           sCE          sMAE          sMSE          MASE         RMSSE 
##  -0.247954848   0.059167405   0.006966025   0.644868599   0.699228950 
##          rMAE         rRMSE          rAME     asymmetry          sPIS 
##   0.204355206   0.212750716   0.076213430  -0.208903973   2.082457237
\end{verbatim}
...
The fit and the forecast from this model are shown in Figure @ref
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-90-1.pdf}
...
## 0.6364 
## 
## Error standard deviation: 1.0919
## Sample size: 110
## Number of estimated parameters: 1
## Number of degrees of freedom: 109
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 146.2060 146.2430 148.9065 148.9935
\end{verbatim}
...
The plot above demonstrates the dynamics of the occurrence variable \(o_t\) and the fitted and predicted probabilities. The oETS\(_F\) model produces the straight line for the probability of 0.64, ignoring the fact that in our example the probability of occurrence has increased over time.
...
## 0.1589 1.0391 
## 
## Error standard deviation: 1.7135
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 112.8376 113.2185 123.6395 124.5348
\end{verbatim}
...
## 20.5590  0.8751 
## 
## Error standard deviation: 2.8658
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 114.1454 114.5264 124.9473 125.8427
\end{verbatim}
...
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 115.5311 116.3467 131.7340 133.6507
\end{verbatim}
...
## 0.9436 
## 
## Error standard deviation: 1.7889
## Sample size: 110
## Number of estimated parameters: 2
## Number of degrees of freedom: 108
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 107.5311 107.6433 112.9321 113.1957
\end{verbatim}
...
## 0.5176 0.9953 
## 
## Error standard deviation: 2.5474
## Sample size: 110
## Number of estimated parameters: 4
## Number of degrees of freedom: 106
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 522.4762 522.8571 533.2781 534.1734
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-93-1.pdf}
...
##           410.1955           406.8972           772.1411           416.1748
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-95-1.pdf}
...
## 29.4808  0.8405 
## 
## Error standard deviation: 3.5819
## Sample size: 110
## Number of estimated parameters: 5
## Number of degrees of freedom: 105
## Information criteria: 
##      AIC     AICc      BIC     BICc 
## 117.6910 118.2680 131.1934 132.5493
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-96-1.pdf}
...
## Loss function type: likelihood; Loss function value: 144.6198
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.3839 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 408.9306 409.7461 425.1334 427.0501 
## 
## Forecast errors:
## Asymmetry: 55.658%; sMSE: 88.712%; rRMSE: 0.785; sPIS: -2388.61%; sCE: 489.815%
\end{verbatim}
...
## Loss function type: likelihood; Loss function value: 138.1953
## Persistence vector g:
##  alpha   beta 
## 0.0094 0.0083 
## Damping parameter: 0.9536
## Sample size: 110
## Number of estimated parameters: 6
## Number of degrees of freedom: 104
## Number of provided parameters: 5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 396.0816 396.8972 412.2845 414.2012 
## 
## Forecast errors:
## Asymmetry: 14.905%; sMSE: 65.889%; rRMSE: 0.676; sPIS: -1077.88%; sCE: 193.619%
\end{verbatim}
...
## Occurrence model type: Inverse odds ratio
## Distribution assumed in the model: Mixture of Bernoulli and Gamma
## Loss function type: likelihood; Loss function value: 162.423
## ARMA parameters of the model:
## AR:
## phi1[1] 
## -0.1795 
...
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 440.5371 440.9180 451.3390 452.2343 
## 
## Forecast errors:
## Asymmetry: 52.397%; sMSE: 80.95%; rRMSE: 0.749; sPIS: -2193.316%; sCE: 444.365%
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-100-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-113-1.pdf}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-114-1.pdf}
...
## 141 257.6562           254.9387            260.4215
## 142 257.7046           253.3911            262.1132
## 143 257.7672           251.8933            263.7117
## 144 257.8138           250.4421            265.2292
## 145 257.8585           248.9247            266.9133
## 146 257.9116           247.4413            268.5692
## 147 257.9624           245.8745            270.2111
## 148 258.0193           244.2672            271.8894
## 149 258.0838           242.7204            273.5840
## 150 258.1386           241.0772            275.4601
\end{verbatim}
...
\begin{verbatim}
##        alpha   beta    phi  level  trend
## alpha  0.015  0.002  0.002  0.014 -0.017
## beta   0.002  0.010 -0.002 -0.016  0.024
## phi    0.002 -0.002  0.013  0.059 -0.064
## level  0.014 -0.016  0.059  0.525 -0.693
## trend -0.017  0.024 -0.064 -0.693  1.000
\end{verbatim}
...
\includegraphics{adam_files/figure-latex/unnamed-chunk-175-1.pdf}
...
What Figure \ref{fig:adamModeliETSCumulative} demonstrates is that for the holdout period of 7 days, the cumulative demand was around 20 units, while the upper bound of the interval was approximately 41. Based on that upper bound we could place an order (based on what we already have in stock) and have an appropriate safety stock.
