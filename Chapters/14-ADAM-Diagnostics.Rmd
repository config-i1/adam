...
This newly constructed model is SARIMAX(2,0,0)(0,1,1)$_{12}$, which differs from the model that we achieved manually. Its residuals are better behaved than the ones of Model 5 (although we might need to analyse the residuals for the potential outliers, as discussed in Subsection \@ref(diagnosticsOutliers)):
