...
In addition, it is possible to derive the log-versions of the Normal, \mathcal{Laplace}, \mathcal{S}, and \mathcal{GN} distributions. The main differences between the original and the log-versions of these functions can be summarised as follows:
\begin{equation}
