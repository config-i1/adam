...
```{r, fig.cap="\\label{fig:statsEfficiecny}An example with biased estimator"}
...
```{r, fig.cap="\\label{fig:statsEfficiecny}An example with inefficient estimator"}
...
```{r, fig.cap="\\label{fig:statsConsistency}An example with inconsistent estimator"}
