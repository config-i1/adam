...
\end{equation}
these models work well in practice, when the data has high values, far from zero, but in the other cases they might produce strange results (e.g. negative values on positive data). So, the conventional decomposition techniques only consider the pure models.
