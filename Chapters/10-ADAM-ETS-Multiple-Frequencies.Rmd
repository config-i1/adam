...
(a) can be considered as a reasonable condition, (b) means that the seasonal indices do not evolve over time. Finally, (c) implies that the error term is not independent, because $\epsilon_{t+m} = -\epsilon_{t+1}- \epsilon_{t+2}- \dots- \epsilon_{t+m-1}$, which violates one of the [basic assumptions](#assumptions) of the model, meaning that \@ref(eq:ETSANAExampleNormalisation01) cannot be considered as the "true" model anymore, as it omits some important elements.
