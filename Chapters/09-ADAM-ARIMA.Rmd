...
@Roberts1982 proposed ETS(A,Ad,N), showing that it is related to the ARIMA(1,1,2) model, with the following connection between the parameters of the two models:
\begin{equation*}
  \begin{aligned}
