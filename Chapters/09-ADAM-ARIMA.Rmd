...
\begin{equation}
  \mathrm{E}({y}_{t+1}|t) = \theta_1 \mathrm{E}(\epsilon_{t}) + \mathrm{E}(\epsilon_{t+1}) = \theta_1 \epsilon_{t}.
...
\begin{equation}
  \mathrm{E}({y}_{t+2}|t) = \theta_1 \mathrm{E}(\epsilon_{t+1}) + \mathrm{E}(\epsilon_{t+2}) = 0.
