...
### Seasonal ETS
The pure additive seasonal ETS models also have connection with ARIMA, but the resulting models are not parsimoinious. For example, ETS(A,A,A) is connected with ARIMA(0,1,m+1)(0,1,0)$_m$.
