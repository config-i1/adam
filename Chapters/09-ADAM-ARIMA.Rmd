...
Finally, the connection between the two models tells us that if we have ARIMA(0,1,q) model, then this model would be suitable for the data called "level" in ETS framework. The length of $q$ would just define the length of memory of the model. The specific impact of each MA parameter of such model on the actual values and forecasts would differ, depending on the order $q$ and calues of parameters.
