...
```{r normalCurveBasic}
plot(seq(-5,5,0.1), dnorm(seq(-5,5,0.1)), xlab=TeX("$\\hat{\\mu}$"), ylab="Density", type="l")
...
plot(seq(-5,5,0.1), dnorm(seq(-5,5,0.1),-1), xlab=TeX("$\\hat{\\mu}$"), ylab="Density", type="l", xlim=c(-5,5),
...
\begin{equation*}
    ...
    \end{aligned}
\end{equation*}
In our case it does not, so we conclude that we reject H$_0$ on 5% significance level.
