...
Despite this simplification, we still need to follow the procedure and select $\alpha$ before conducting the test! We should not change the significance level after observing the p-values, otherwise we are trying to beautify the reality.
...
While p-value is a comfortable thing, I personally prefer using confidence interval, because they show the uncertainty clearer. Consider the following cases to see what I mean:
