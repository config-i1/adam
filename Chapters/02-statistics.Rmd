...
\begin{equation} \label{eq:GND}
    f(y_t) = \frac{\beta}{2 \sqrt[^\beta]{s} \Gamma(\beta^{-1})} \exp \left( -\frac{|y_t - \mu_t|^{\beta}}{s} \right),
\end{equation}
