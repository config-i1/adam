...
While this distribution is not ideal, it has the bell shape of Normal distribution. We then try a value of parameters $\hat{\mu}_y=80$ and $\hat{\sigma}=10$ just to see how the probability density function of normal distribution fits the data:
