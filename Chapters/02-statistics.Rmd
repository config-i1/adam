...
Similarly, we can produce violin plots for the same data (see Figure \@ref(vioGearMPG)).

```{r vioGearMPG, fig.cap="Violin plot of mileage vs number of gears"}
