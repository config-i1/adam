...
etsAdditiveTable <- matrix(etsAdditiveTable, 5, 3, byrow=TRUE,
                           dimnames=list(c("N","A","Ad","M","Md"),
                                         c("N","A","M")))
kableTable <- kableExtra::kable(etsAdditiveTable, escape=FALSE)
add_header_above(kable_styling(kableTable, font_size=10),c("Trend","Seasonal"=3),escape=FALSE)
```
