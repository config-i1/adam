...
\begin{equation}
    r_{x,y} = \sign{\hat{b}_1} \sqrt{\hat{a}_1 \hat{b}_1} = \sign{\mathrm{cov}(x,y)} \sqrt{\frac{\mathrm{cov}(x,y)}{\mathrm{V}(x)} \frac{\mathrm{cov}(x,y)}{\mathrm{V}(y)}} = \frac{\mathrm{cov}(x,y)}{\sqrt{V(x)V(y)}} .
    (\#eq:correlationDerivationPearson)
\end{equation}
This is how the correlation coefficient was originally derived.
