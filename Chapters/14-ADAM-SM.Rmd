...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
If we assume that $\epsilon_t \sim \mathcal{N}(0,\sigma^2_t)$, then the general scale model with ETS+ARIMA+Reg elements can be formulated as (Section \@ref(ADAMETSPureMultiplicative), Subsection \@ref(eq:ADAMSMGeneralARIMA) and Section \@ref(ADAMXDynamic)):
\begin{equation}
  \begin{aligned}
