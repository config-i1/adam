...
Similarly to the oETS$_O$, the model captures the trend in the probability of occurrence, but has a higher smoothing parameters $\alpha$ and thus is more reactive.
