...
\begin{equation}
  ...
  (\#eq:BernoulliPMF)
\end{equation}
The occurrence part of the model can be estimated via the maximisation fo the log-likelihood, which comes directly from \@ref(eq:BernoulliPMF), and in the most general case is:
\begin{equation}
