...
Sometimes the terms "count data" and "integer-valued data" are used in a similar context, but there is a difference between them and intermittent data. These terms imply that demand can take integer values only and can be typically modelled via Poisson, Binomial or Negative Binomial distributions. They do not explicitly allow demand to happen at random and they assume that zero demand is just one of the possible values of a distribution. In case of intermittent demand, we explicitly acknowledge that demand might not happen, but if it happens then the demand size will be greater than zero. Having said that, count distributions can be used in some cases of intermittent demand, but they do not necessarily always provide a good approximation of complex reality.
