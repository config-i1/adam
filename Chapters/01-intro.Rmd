...
15. Automatic outliers detection;
16. Handling missing data;
17. Fine tuning of persistence vector (smoothing parameters);
18. Fine tuning of initial values of the state vector (e.g. level / trend / seasonality);
19. Two initialisation options (optimal / backcasting);
20. Provided ARMA parameters;
21. Fine tuning of optimiser (select algorithm and convergence criteria);
