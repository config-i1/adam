...
Before we move to the discussion of models and their estimation it makes sense to discuss the forecasting proces and how the forecasts should be evaluated.
