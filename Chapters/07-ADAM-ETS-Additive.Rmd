...
Based on this formulation, in this and the next few chapters, we will discuss several special cases of the ADAM ETS model and explain how they can be extended.


## Pure additive ETS: model formulation {-}
