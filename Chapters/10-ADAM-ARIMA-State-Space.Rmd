...
1. For ETS(A,N,N)+ARIMA(0,1,q), use ARIMA(0,1,q) in case of with $q >1$ and ETS(A,N,N) in case of $q\leq 1$;
2. For ETS(A,A,N)+ARIMA(0,2,q), use ARIMA(0,2,q) in case of with $q >2$ and ETS(A,A,N) in case of $q \leq 2$;
3. For ETS(A,Ad,N)+ARIMA(p,1,q), use ARIMA(p,1,q), when either $p>1$ or $q>2$ and ETS(A,Ad,N), when $p \leq 1$ and $q \leq 2$.
