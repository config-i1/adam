...
Using \@ref(eq:MSARIMAState), we can express the actual value based on the last equation for the state $v_{K,t}$ in the transition matrix:
\begin{equation}
...
\begin{equation}
  v_{i,t} = \frac{v_{K,t} - \theta_K \epsilon_{t}}{} + \theta_i \epsilon_{t} = \frac{\eta_i}{\eta_K} v_{K,t} + \left( \theta_i - \frac{\theta_K}{\eta_K} \right) \epsilon_{t} .
