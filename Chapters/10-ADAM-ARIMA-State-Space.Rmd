...
In this model, each state of $v_{i,t}$ needs to be initialised with $i$ values (e.g. 1 for the first state, 2 for the second etc). This leads in general to more initial states than the SSARIMA from @Svetunkov2019. However, this formulation leads to more compact transition matrix, leading to improvements in terms of applying the model to the data with large $K$.
