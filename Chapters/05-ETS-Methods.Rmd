...
es(x$data, "ANN", h=12, interval=TRUE, holdout=TRUE, silent=FALSE)
```
...
```{r}
x <- sim.es("AAM", 120, 1, 4, persistence=c(0.3,0.1,0.2), initial=c(1000,20), initialSeason=c(0.9,1.1,0.8,1.2), mean=0, sd=20)
plot(x)
```
