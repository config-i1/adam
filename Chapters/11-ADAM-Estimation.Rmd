...
::: remark
The part $\frac{1}{2} \sum_{t=1}^T \frac{\epsilon_t^2}{\sigma^2}$ does not contain $\mu_{y,t}$ because when inserted in the formula of Normal distribution, the numerator is: $y_t - \mu_{y,t}$, which is based on \@ref(eq:ETSADAMNormalDistributionExample02) is $\mu_{y,t} \epsilon_t$. After inserting in the formula for the Normal distribution that part becomes: $\frac{1}{2} \sum_{t=1}^T \frac{(\mu_{y,t} \epsilon_t)^2}{\mu_{y,t}^2\sigma^2}$ which after cancellations leads to \@ref(eq:ETSADAMNormalDistributionExample04).
:::
