...
The main difference between using these losses and maximising the likelihoods is in the [number of estimated parameters](#statisticsNumberOfParameters): the latter implies that the scale is estimated together with the other parameters, while the former does not consider it.
