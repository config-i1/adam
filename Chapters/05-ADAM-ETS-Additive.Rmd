...
The pure additive case is interesting, because this is the group of models that has closed forms for both conditional mean and variance. It is based on the model discussed in subsection \@ref(ETSConventionalModelAdditive) and is formulated in the following way:
\begin{equation}
  \begin{aligned}
