...
<!-- Residuals vs specific variables -->

There are formal statistical tests for heteroscedasticity, such as White [@WikipediaWhite2021], Breusch-Pagan [@WikipediaBreuschPagan2021] and Bartlett's [@WikipediaBartlett2021]. We do not discuss them here for the reason discussed in Section \@ref(diagnosticsResidualsIIDAuto).
