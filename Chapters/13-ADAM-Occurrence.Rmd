...
While there are different ways of estimating the parameters of the ADAM model \@ref(eq:iETSG), it is worth focusing on likelihood estimation (Section \@ref(ADAMETSEstimationLikelihood)) for consistency with other ADAM models. The likelihood of the model will consist of several parts:
