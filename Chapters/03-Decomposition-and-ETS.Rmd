...
One of the most powerful and efficient forecasting methods for level time series [which is very popular in practice according to @LCFweller2012] is Simple Exponential Smoothing (sometimes also called "Single Exponential Smoothing"). It was first formulated by @Brown1956 and can be written as:
\begin{equation}
