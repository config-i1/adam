...
\end{equation}
where $\breve{y}_t$ is the point value based on all non-seasonal components (e.g. $\breve{y}_t=l_{t-1}+\phi b_{t-1}$ in case of damped trend model) and $\gamma_i$ is the $i$-th seasonal smoothing parameter.
