...
# save(adamETSMNMGTMSE, adamETSMNMAR, adamETSXMNN, adamETSXMNNGTMSE, adamETSXMNMGTMSE,
#      file="data/adamModelETSMNMTaylor.Rdata")
```
### ADAM ETS
...
Now that we created the data with categorical variables, we can fit the ADAM ETSX model with dummy variables for days of the week and use complete backcasting for initialisation (for speed):
...
### ADAM ARIMA {#ADAMMultipleFrequenciesExamplesARIMA}
