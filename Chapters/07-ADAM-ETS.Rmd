...
Because we used `holdout` parameter, the function now also reports the errors for the point forecasts on that part of data. This can be useful, when you want to compare the performance of several models on a time series. 
