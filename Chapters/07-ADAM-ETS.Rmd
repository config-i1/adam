...
\end{equation}
In many cases the smoothing parameters for the pure additive models will be small enough for this limit to hold, so the two models will become equivalent.
