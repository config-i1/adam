...
In this chapter we discuss briefly the conventional ETS taxonomy, as formulated in @Hyndman2008b and demonstrate its connection to the [time series components](#tsComponents), discussed in [the previous chapter](#tsDecomposition).
