...
adamiETSyForecast <- forecast(adamiETSy, h=7,
                              ...
                              side="upper")
```
Given that we deal with cumulative values, the basic plot will not be helpful, and we should produce something different. One of the options is the following (see Figure \@ref(fig:adamModeliETSCumulative)):

```{r adamModeliETSCumulative, fig.cap="The actual cumulative demand (black dot), the expectation (the solid blue line), and the 95% quantile of the distribution of the cumulative demand (the dashed grey line) based on the iETS model."}
