...
<!-- Basic analytical one for pure additive models -->

<!-- Connection with scales of distributions -->

<!-- Analytical one for scale model and its connection with the conventional one -->
