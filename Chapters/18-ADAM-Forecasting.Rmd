...
Graphically, the result of this approach is shown in Figure \@ref(fig:adamScenarios), where each separate path is shown in grey colour and the expectation is in black.
...
adam(BJsales, "YYN", h=10, holdout=TRUE) |>
    forecast(h=10, interval="simulated", scenarios=TRUE, nsim=100) ->
    adamForecast
...
for(i in 1:ncol(adamForecast$scenarios)){
    lines(adamForecast$scenarios[,i], col="grey")
}
