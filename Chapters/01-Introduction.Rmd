...
While we do not aim to fully cover the topic of models, methods, and typical assumptions of statistical models, we need to make several important definitions to clarify what we will discuss in this monograph. For a more detailed discussion, see Chapters 1 and 12 of @SvetunkovSBA.
