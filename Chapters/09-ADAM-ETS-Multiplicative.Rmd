...
\end{equation}
where $\mu_{y,t+h}$ is the conditional h steps ahead expectation, $\check{y}_{t+h}$ is the conditional h steps ahead geometric expectation (aka geometric mean) and $\hat{y}_{t+h}$ is the [point forecast](#ETSTaxonomyMaths) [@Svetunkov2020ETS].
