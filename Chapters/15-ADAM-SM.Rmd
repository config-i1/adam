...
The equations above can be used instead of the first equation in \@ref(eq:ADAMSMGeneral) to create and estimate Scale Model for the chosen distribution: the other four equations in \@ref(eq:ADAMSMGeneral) will be exactly the same.
