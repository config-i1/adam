...
The `es()` function from the `smooth` package implements the conventional ETS, supporting all 30 models and implementing some modifications of the original model (e.g. explanatory variables and advanced estimators).
