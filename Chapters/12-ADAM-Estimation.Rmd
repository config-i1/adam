...
# Gamma distribution
                        ...
                        "$-T \\log \\Gamma \\left(s^{-1}\\right) - \\frac{T}{s} \\log s - \\sum_{t=1}^T \\log y_t$",
                        "$\\hat{s} = \\frac{1}{T} \\sum_{t=1}^T \\left(\\frac{e_t}{\\mu_{y,t}}\\right)^2$\textbf{*}",
# logN distribution
...
# Gamma distribution
                        ...
                        "$-T \\log \\Gamma \\left(s^{-1}\\right) - \\frac{T}{s} \\log s - \\sum_{t=1}^T \\log y_t$",
                        "$\\hat{s} = \\frac{1}{T} \\sum_{t=1}^T e_t^2$\textbf{*}",
# logN distribution
