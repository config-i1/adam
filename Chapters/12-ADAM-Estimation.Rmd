...
6. Finally, in order to make $\lambda$ slightly more meaningful, we also divide the MSE part of the loss by $\mathrm{V}\left({\Delta}y_t\right)$, where ${\Delta}y_t=y_t-y_{t-1}$. This sort of scaling helps in both cases, when there is a trend in the data and when the data does not exhibit one.
