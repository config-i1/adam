...
# Gamma distribution
                        ...
                        "$\\begin{split} &-T \\log \\Gamma \\left(s^{-1}\\right) - \\frac{T}{s} \\log s + \\\\
                                         &\\frac{1}{\\sigma^2} \\sum_{t=1}^T \\log \\left(\\frac{1+\\epsilon_t}{\\mu_{y,t} \\exp((1+\\epsilon_t) / \\mu_{y,t})}\\right) - \\sum_{t=1}^T \\log y_t\\end{split}$",
...
# Gamma distribution
                        ...
                        "$\\begin{split} &-T \\log \\Gamma \\left(s^{-1}\\right) - \\frac{T}{s} \\log s + \\\\
                                         &\\frac{1}{\\sigma^2} \\sum_{t=1}^T \\log \\left(\\frac{1+\\epsilon_t}{\\exp(1+\\epsilon_t)}\\right) - \\sum_{t=1}^T \\log y_t\\end{split}$",
