...
```{r roExample01, fig.cap="Boxplots of error measures of two methods."}
...
The boxplots in Figure \@ref(fig:roExample01) can be interpreted as any other boxplots applied to random variables [see for example, discussion in Section 2.2 of @SvetunkovSBA].
