...
Another potential simplification would be to use deterministic seasonality for some of seasonal frequencies. The possible solution in this case is to use [explanatory variables](#ADAMX) for the higher frequency states (see discussion in the (next section)[#ETSXMultipleSeasonality]).
