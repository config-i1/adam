...
<!-- Additional model based on alm -->


<!-- ## Model is correctly specified: Omitted variables -->
<!-- Residuals vs potential variables -->
<!-- Missing structure -->


<!-- ## Model is correctly specified: Redundant variables -->
<!-- Critical analysis -->
