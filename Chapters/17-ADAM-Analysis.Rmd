# Model diagnostics
In this chapter we investigate how ADAM can be diagnosed and improved. The majority of topics will build upon the typical model assumptions discussed in Section \@ref(assumptions). In order to make this more actionable, we will consider an example of the following ADAM ETS model:
