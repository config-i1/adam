...
In this chapter, we discuss these questions. We start with principles based on information criteria [addressed in Chapter 16 of @SvetunkovSBA] for ETS and ARIMA. We then move to selecting explanatory variables and finish with topics related to the combination of models.
...
The basic idea underlying the components selection in ETS is based on information criteria [Section 16.4 of @SvetunkovSBA]. The general procedure consists of the following three steps:
