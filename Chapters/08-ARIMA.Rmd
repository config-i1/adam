...
# ARIMA(1,1,2)
adamARIMABJ[[1]] <- adam(BJsales, "NNN", orders=c(1,1,2),
                         h=10, holdout=TRUE)
# ARIMA(0,2,2)
adamARIMABJ[[2]] <- adam(BJsales, "NNN", orders=c(0,2,2),
                         h=10, holdout=TRUE)
# ARIMA(1,1,1)
adamARIMABJ[[3]] <- adam(BJsales, "NNN", orders=c(1,1,1),
                         h=10, holdout=TRUE)
...
par(mfcol=c(1,2))
plot(adamARIMABJ[[2]], c(10,11), main="")
```
...
adamSARIMAAir[[1]] <- adam(AirPassengers, "NNN", lags=c(1,12),
                           orders=list(ar=c(0,0), i=c(2,1),
                                       ma=c(2,1)),
                           h=12, holdout=TRUE)
# SARIMA(0,2,2)(1,1,1)[12]
adamSARIMAAir[[2]] <- adam(AirPassengers, "NNN", lags=c(1,12),
                           orders=list(ar=c(0,1), i=c(2,1),
                                       ma=c(2,1)),
                           h=12, holdout=TRUE)
# SARIMA(0,2,2)(1,1,0)[12]
adamSARIMAAir[[3]] <- adam(AirPassengers, "NNN", lags=c(1,12),
                           orders=list(ar=c(0,1), i=c(2,1),
                                       ma=c(2,0)),
                           h=12, holdout=TRUE)
...
plot(forecast(adamSARIMAAir[[1]], h=12,
              interval="prediction"),
     main="")
```
