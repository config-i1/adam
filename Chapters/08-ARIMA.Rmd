...
x <- sim.ssarima(orders=list(ar=3), lags=1, obs=120, AR=c(0.9, -0.7, 0.6), initial=c(10,15,20), mean=0, sd=10)
...
x <- sim.ssarima(orders=list(ma=3), lags=1, obs=120, MA=c(0.9, -0.3, -0.6), initial=c(10,10,5), mean=0, sd=10)
...
x <- sim.ssarima(orders=list(ar=3, ma=3), lags=1, obs=120, AR=c(0.9, -0.7, 0.6),
...
x <- sim.ssarima(orders=list(ar=1,i=1,ma=2), lags=1, obs=120, AR=0.7, initial=c(500, -350),
            mean=0, sd=10)
