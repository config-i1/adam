...
A very important thing to note is that this textbook **does not use `tidyverse` packages**. I like base R, and, to be honest, I am sure that `tidyverse` packages are great, but I never needed them. So, I will not use pipeline operators, I will not use `tibble` or `tsibble` objects and I do not use `ggplot2`. It is assumed throughout the textbook that you can do all those nice tricks for data transformation on your own if you want to.
